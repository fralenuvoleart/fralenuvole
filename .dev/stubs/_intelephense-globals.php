<?php
/**
 * Consolidated Intelephense global function stubs.
 *
 * All WPML/Polylang functions called by this codebase, declared in one file
 * with function_exists guards matching the existing per-plugin stubs.
 *
 * This file is indexed by Intelephense via includePaths. PHPStan uses the
 * separate per-plugin stub files (wpml.php, polylang.php, etc.) loaded as
 * bootstrapFiles in phpstan.neon.
 */

// ---------------------------------------------------------------------------
// WPML / Polylang WPML-compatibility functions
// ---------------------------------------------------------------------------
