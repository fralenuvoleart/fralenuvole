...
Now use your previous architectural review of translator to write docs/TRANSLATOR.md, which serves as future reference for devs that want to understand the themekit features and behaviour
