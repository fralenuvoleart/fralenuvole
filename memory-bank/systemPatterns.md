...
- **Module keys:** Underscores only (e.g. `call_to_actions`). Hyphens break `$$var_name` dereference in [`functions-modules.php:251`](includes/helpers/functions-modules.php:251).
