...
| Log Manager | `admin/components/class-display-log.php` | Streaming debug.log viewer (chunked forward/reverse reads for files >256KB), AJAX refresh/clear/download, entry-count transient cache. |
