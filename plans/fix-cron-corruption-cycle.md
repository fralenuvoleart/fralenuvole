...
The original [`frl_add_exclusion_filter_cron()`](includes/mu/functions-mu.php:387) rebuilt the entire cron array from scratch using a `$filtered` accumulator. This required:
