...
<?php
     ...
     * @return void
     */
    public function render_form_tab_content($tab_id, $sections_data, $field_callback, $args = [])
    {
        $tab_specific_section_ids = $sections_data[$tab_id] ?? [];
        ...
        foreach ($tab_specific_section_ids as $section_id_to_render) {
            if (!isset($sections_data[$section_id_to_render])) {
                continue;
            }

            $fields_for_this_section = $sections_data[$section_id_to_render];
