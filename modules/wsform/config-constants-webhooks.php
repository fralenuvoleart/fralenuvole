...
const WSFORM_WEBHOOK_DEDUPE_REFERENCE_KEYS = array( 'Reference ID', 'reference_id' );
const WSFORM_WEBHOOK_DEDUPE_CHANNEL_KEYS   = array( 'Preferred contact method', 'Contact method' );
